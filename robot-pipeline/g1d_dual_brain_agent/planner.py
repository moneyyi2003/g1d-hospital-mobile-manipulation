...
def compile_family_home_command(
    ...
    *,
    ...
    return compile_family_home_selection(
        instruction,
        outbound_place_id=outbound_phrase,
        object_id=object_phrase,
        return_place_id=return_phrase,
...
def compile_family_home_selection(
    instruction: str,
    *,
    ...
    """Compile a go-pick-return mission from catalog-grounded selections.

    The caller may be a constrained LLM.  Each supplied value is still matched
    against approved catalog entries here, so the model cannot promote a
    rejected item or introduce coordinates.
    """
    ...
    goals = (
        TaskGoal(
            ...
            metadata={
                ...
                "source_phrase": outbound_place_id,
            },
        ),
        TaskGoal(
            goal_id="pick-object",
