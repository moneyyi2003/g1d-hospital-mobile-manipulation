"""Constrained DeepSeek intent resolution for the Hospital dashboard."""
...
class HospitalIntentResolver:
    """Resolve free-form language to one approved Hospital place id."""
...
__all__ = ["HospitalIntentResolver", "HospitalPlaceResolution"]
